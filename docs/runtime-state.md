...
The current review artifact is the three-direction, same-data intent comparison
at
`samples/dashboard/intent_comparison/verified_observation_surface_intent_pack.html`.
Its manifest and automated readback are in the same directory, and its
supporting research is `docs/design/DASHBOARD_LAYOUT_RESEARCH_V1.md`. The
production dashboard and generator remain separate and unchanged by this
review checkpoint.
